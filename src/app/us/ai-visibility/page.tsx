        ...
        <div className="container-content">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-body text-white/60 mb-10 max-w-3xl mx-auto">
              The V.O.I.C.E. scanner tells you exactly where you stand. Run a free
      ...
      <section className="bg-white py-12 border-b border-brand-navy/10">
        <div className="container-content">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-muted mb-4">
              V.O.I.C.E. stands for Visibility, Optimisation, for Intelligent,
              Crawler, Engines. It is a free tool built by{' '}
              <Link href="/us/services" className="text-brand-gold font-medium hover:underline">
                ScopeSite Digital Studios
              </Link>{' '}
              that measures how well AI systems can read and recommend your website.
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="p-6 rounded-xl bg-white border border-brand-navy/10">
                ...
                <p className="text-light text-sm mb-3">
                  ...
                  rendering, full schema markup, and the V.O.I.C.E. methodology. Your
        ...
        <div className="container-content">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-muted max-w-3xl mx-auto mb-6">
              ScopeSite used the V.O.I.C.E. methodology to make H4TLT (Hearing 4
        ...
        <div className="container-content">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-white-muted max-w-2xl mx-auto">
              Common questions about the V.O.I.C.E. scanner and AI visibility
            </p>
          </div>
