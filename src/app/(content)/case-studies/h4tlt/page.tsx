          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <FadeInOnScroll delay={0.45}>
              <div className="flex flex-col items-center gap-4">
                <Link href={VOICE_PRODUCT_PATH} className="btn-primary text-lg px-10 py-5 rounded-lg">
      ...
      <section className="bg-brand-graphite py-16">
        <div className="container-content text-center">
          <FadeInOnScroll>
            ...
            <Link href={VOICE_PRODUCT_PATH} className="btn-primary text-lg px-8 py-4 rounded-lg animate-pulse-cta inline-block mb-4">
      ...
      <section className="bg-brand-graphite py-16">
        <div className="container-content text-center">
          <FadeInOnScroll>
            ...
            <Link href={VOICE_PRODUCT_PATH} className="btn-primary text-lg px-8 py-4 rounded-lg inline-block">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <FadeInOnScroll delay={0.3}>
              <div className="flex flex-col items-center gap-6">
                <Link href={VOICE_PRODUCT_PATH} className="btn-primary text-xl px-12 py-6 rounded-lg shadow-2xl hover:scale-105 transition-transform duration-300">
                  Check your site for free →
                </Link>
