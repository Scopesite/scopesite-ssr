      ...
      <LandingHero
        ...
        bodyCopy={
          <>
            ...
            <p>
              Check your current <Link href="/ai-visibility" className="text-brand-gold hover:underline">AI visibility</Link> with our free V.O.I.C.E. scan, or see our full range of <Link href="/ai-seo-services" className="text-brand-gold hover:underline">AI SEO services</Link>.
            </p>
          </>
        }
