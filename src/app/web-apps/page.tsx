...
const faqItems = [
  {
    ...
    answer: 'It depends entirely on complexity. These figures are indicative only and are not generated by the website quote calculator. A simple calculator might be £1,500-3,000. A full client portal with authentication could be £5,000-15,000+. We scope every project individually and give you a fixed quote before starting - no surprises.',
  },
  {
