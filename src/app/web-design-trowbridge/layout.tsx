...
export const metadata: Metadata = {
  ...
  description: 'Web design for Trowbridge businesses. AI-optimised sites built by ScopeSite, 12 miles away in Frome. Next.js, 100/100 Lighthouse, transparent pricing.',
  openGraph: {
