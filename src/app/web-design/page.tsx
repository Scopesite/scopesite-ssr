        ...
        <div className="container-content relative z-10">
          <FadeInOnScroll>
            <div className="text-center mb-8">
              ...
              <div className="flex justify-center items-center gap-8 md:gap-12">
                ...
                {/* Notion */}
                <div className="opacity-40 hover:opacity-70 transition-opacity">
                  <svg className="h-10 w-auto text-white" viewBox="0 0 100 100" fill="currentColor" aria-hidden="true">
          ...
          <FadeInOnScroll delay={0.2}>
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
              ...
              >
                <svg className="w-8 h-8 text-white" viewBox="0 0 180 180" fill="currentColor" aria-hidden="true">
              ...
              >
                <svg className="w-6 h-6 text-white" viewBox="0 0 76 65" fill="currentColor" aria-hidden="true">
              ...
              >
                <svg className="w-8 h-8 text-[#61DAFB] group-hover:text-[#61DAFB]" viewBox="-11.5 -10.232 23 20.463" fill="currentColor" aria-hidden="true">
                  <circle r="2.05"/>
              ...
              >
                <svg className="w-8 h-8 text-[#38BDF8] group-hover:text-[#38BDF8]" viewBox="0 0 54 33" fill="currentColor" aria-hidden="true">
