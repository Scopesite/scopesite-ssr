            ...
            <div className="text-center mb-8">
              ...
              <div className="flex justify-center items-center gap-8 md:gap-12">
                ...
                <div className="opacity-40 hover:opacity-70 transition-opacity">
                  <svg className="h-8 w-auto text-white" viewBox="0 0 60 25" fill="currentColor">
                    <path d="M59.64 14.28h-8.06c.19 1.93 1.6 2.55 3.2 2.55 1.64 0 2.96-.37 4.05-.95v3.32a8.33 8.33 0 0 1-4.56 1.1c-4.01 0-6.83-2.5-6.83-7.48 0-4.19 2.39-7.52 6.3-7.52 3.92 0 5.96 3.28 5.96 7.5 0 .4-.02 1.04-.06 1.48zm-6.3-5.63c-1.03 0-1.9.73-2.1 2.48h4.09c-.02-1.2-.52-2.48-1.99-2.48zM42.17 0v20.75h4.56V0h-4.56zm-4.95 5.53l-.3 1.52h-4.01V20.8h4.56V11.1c.84-1.47 2.34-1.25 2.79-1.1V5.53c-.49-.18-2.21-.53-3.04 1.52v-1.52zm-9.08 1.27c-.9-.48-2.13-.58-3.1-.58-1.85 0-3.03.6-3.03 1.8 0 1.78 3.24 1.57 4.39 2.45v3.7c-1.51.7-3.33.97-5.09.97-2.32 0-4.3-.68-4.3-3.5 0-2.97 2.53-3.77 5.09-3.77.9 0 1.76.12 2.6.35V5.53h3.44v1.27zm-6.06 8.4c.59 0 1.25-.09 1.66-.28v-2.14c-.71-.4-2.84-.7-2.84.89 0 .77.56 1.53 1.18 1.53zM9.95 5.27c-2.37 0-4.36 1.37-4.36 3.64 0 2.63 2.01 3.28 4.17 3.73 1.32.28 2.08.5 2.08 1.21 0 .6-.52 1.06-1.58 1.06-1.56 0-3.27-.73-4.51-1.54v3.74c1.22.68 2.83 1.2 4.59 1.2 2.78 0 4.77-1.35 4.77-3.73 0-2.48-1.74-3.28-4.09-3.76-1.37-.29-2.18-.52-2.18-1.2 0-.54.49-.91 1.41-.91 1.18 0 2.68.52 3.89 1.2V5.92c-1.12-.44-2.5-.65-4.19-.65zM0 5.53h4.56V20.8H0V5.53z"/>
                  </svg>
                </div>
                {/* Notion */}
                <div className="opacity-40 hover:opacity-70 transition-opacity">
                  <svg className="h-7 w-auto text-white" viewBox="0 0 100 100" fill="currentColor">
                ...
                {/* Nike */}
                <div className="opacity-40 hover:opacity-70 transition-opacity">
                  <svg className="h-6 w-auto text-white" viewBox="0 0 69 32" fill="currentColor">
                    <path d="M68.56 4L18.4 25.36Q12.16 28 7.92 28Q4 28 2.2 26.12A5.73 5.73 0 0 1 .56 22.6L.56 22.6Q.24 18.24 6.68 13.6A42.89 42.89 0 0 1 18.88 7.04L18.88 7.04L31.52 2L18.4 7.68Q7.2 12.64 3.92 16.72L3.92 16.72Q2.08 19.12 3.56 20.68T8.32 22.24L8.32 22.24Q11.76 22.24 18.12 19.44L18.12 19.44L68.56 4Z"/>
                  </svg>
                </div>
              </div>
            </div>
