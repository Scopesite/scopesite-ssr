      ...
      <section className="bg-brand-navy pt-12 pb-8">
        <div className="container-content text-center">
          ...
          <p className="text-body-lg text-white/80 max-w-2xl mx-auto">
            Struggling to find what you&apos;re looking for? Book a free 1:1 Google Meet with 
            <strong className="text-brand-gold"> Dan Cartwright</strong>, the director of ScopeSite, 
            where he&apos;ll help determine the best solution for your project.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <Suspense fallback={
              <div className="h-[900px] flex items-center justify-center">
                <div className="text-white/60">Loading booking calendar...</div>
              </div>
            }>
              <FilloutEmbed />
            </Suspense>
      ...
      <section className="py-12 bg-brand-navy/5">
        <div className="container-content">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-h2 text-brand-gold font-headline mb-2">30 min</div>
              <div className="text-body-sm text-brand-graphite">Quick & focused call</div>
            </div>
            <div>
              <div className="text-h2 text-brand-gold font-headline mb-2">100%</div>
              <div className="text-body-sm text-brand-graphite">Free, no obligation</div>
            </div>
            <div>
              <div className="text-h2 text-brand-gold font-headline mb-2">24hr</div>
              <div className="text-body-sm text-brand-graphite">Response time</div>
            </div>
          </div>
        </div>
      </section>
