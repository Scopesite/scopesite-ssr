...
const FOOTER_LINKS = {
  ...
  localServices: [
    ...
    { label: 'Web Design Frome', href: '/web-design-frome' },
    { label: 'Web Design Glastonbury', href: '/web-design-glastonbury' },
    { label: 'Web Design Burnham-on-Sea', href: '/web-design-burnham-on-sea' },
    { label: 'Web Design Trowbridge', href: '/web-design-trowbridge' },
    { label: 'Web Design Warminster', href: '/web-design-warminster' },
    { label: 'Web Design Shepton Mallet', href: '/web-design-shepton-mallet' },
    { label: 'Web Design Westbury', href: '/web-design-westbury' },
    { label: 'SEO Somerset', href: '/seo-somerset' },
    { label: 'SEO Bristol', href: '/seo-bristol' },
    { label: 'SEO Frome', href: '/seo-frome' },
  ],
  company: [
...
const SOCIAL_LINKS = [
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/scopesitedigitalstudios',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
